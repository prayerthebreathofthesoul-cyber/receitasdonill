...
export const Route = createFileRoute("/receita/$slug")({
  ...
  head: ({ params, loaderData }) => {
    ...
    const desc =
      r.meta_description ||
      r.excerpt ||
      `Aprenda a fazer ${r.title} com passo a passo claro.`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            author: {
              "@type": "Person",
              name: r.author_name || "Receitas do Nill",
            },
                ...
                ? [
                    {
                      ...
                      item: `/categoria/${r.category.slug}`,
                    },
                  ]
                : []),
              {
                "@type": "ListItem",
                position: r.category ? 3 : 2,
                name: r.title,
                item: `/receita/${params.slug}`,
              },
            ],
          }),
        },
  ...
  notFoundComponent: () => (
    <div className="mx-auto max-w-2xl px-4 py-20 text-center">
      ...
      <p className="mt-3 text-muted-foreground">
        Talvez ela tenha sido movida. Explore outras receitas na home.
      </p>
